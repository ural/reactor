...
gulp.task('css_custom', function () {
    gulp.src(config.paths.css_custom)
        .pipe(concat('css_custom.css'))
        .pipe(gulp.dest(config.paths.dist + '/css'))
        .pipe(connect.reload());
});
...
gulp.task('default', ['html', 'lint', 'css', 'css_custom', 'js', 'images', 'open', 'watch']);
